...
This map uses open data from No More Deaths to show recovered migrant remains along the border from 2002 to 2025. However the records undercount the true scale of loss. Many people who go missing are never found, and data quality varies by region and across the years.
